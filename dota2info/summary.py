"""
Try and extract useful information from a demson file
"""
...
class Player(object):
    ...
    def __init__(self):
        ...
        #TODO: damage dealt for everything?
...
class DemoSummary(object):
    ...
    def parse(self):
        ...
        #TODO: the fun starts here
        self.dp = parser.DemoParser(self.filename, verbosity=4,
...
def main():
    import argparse
    p = argparse.ArgumentParser(description="Dota 2 demson parser")
    p.add_argument('demo', help="The .demson file to parse")
    p.add_argument('--out', dest="outputFile", default=None, 
                        help="where the summary is written (optional)")

    args = p.parse_args()

    #TODO: read file linewise, process each line accordingly, 
